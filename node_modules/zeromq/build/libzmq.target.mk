...
zmq/BUILD_SUCCESS: export BUILT_FRAMEWORKS_DIR := ${abs_builddir}
zmq/BUILD_SUCCESS: export BUILT_PRODUCTS_DIR := ${abs_builddir}
zmq/BUILD_SUCCESS: export CONFIGURATION := ${BUILDTYPE}
zmq/BUILD_SUCCESS: export PRODUCT_NAME := libzmq
zmq/BUILD_SUCCESS: export SDKROOT := /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk
zmq/BUILD_SUCCESS: export SRCROOT := ${abs_srcdir}/
zmq/BUILD_SUCCESS: export SOURCE_ROOT := ${SRCROOT}
zmq/BUILD_SUCCESS: export TARGET_BUILD_DIR := ${abs_builddir}
zmq/BUILD_SUCCESS: export TEMP_DIR := ${TMPDIR}
zmq/BUILD_SUCCESS: export XCODE_VERSION_ACTUAL := 1330
